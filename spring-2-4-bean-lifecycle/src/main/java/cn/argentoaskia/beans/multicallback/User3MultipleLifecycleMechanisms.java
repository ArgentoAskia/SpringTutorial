package cn.argentoaskia.beans.multicallback;
...
public class User3MultipleLifecycleMechanisms extends User3 implements InitializingBean, DisposableBean {
    ...
    public void shutdown(){
        System.out.println("3.destroy-method方式销毁在最开始被调用，destroy-method优先级最高");
    }
    ...
    public void destroy2(){
        System.out.println("1.@PreDestroy方式销毁在最后被调用，优先级最低");
    }
